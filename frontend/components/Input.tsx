...
export const Input = forwardRef<HTMLInputElement, InputProps>(
  ({ label, error, helperText, className, showPasswordToggle, type, ...props }, ref) => {
          ...
          <input
            ...
            className={classNames(
              ...
              error
                ...
                : 'border-slate-200 dark:border-slate-700 focus:border-blue-500 bg-white dark:bg-slate-800',
